  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      <div className="relative mb-5 md:mb-7">
        <div className="flex flex-col gap-4 sm:gap-5 lg:grid lg:grid-cols-[minmax(0,1fr)_auto] lg:items-start lg:gap-8">
          ...
          <CurrentWeather
            variant="compact"
            className="w-full shrink-0 sm:max-w-[13rem] lg:justify-self-end lg:mt-1"
          />
        </div>
      </div>

      <div className="relative max-w-3xl rounded-r-lg border-l-2 border-primary/40 bg-background/25 py-0.5 pl-4 backdrop-blur-[2px] md:pl-6">
      ...
      <div className="mt-6 flex min-h-0 flex-1 flex-col gap-6 lg:mt-8 lg:flex-row lg:items-stretch lg:gap-8">
        <div className="flex min-h-0 min-w-0 flex-1 flex-col">
          <GeminiChat />
        </div>
        <aside className="flex shrink-0 flex-row flex-wrap items-start justify-between gap-x-8 gap-y-4 border-t border-border/50 pt-6 sm:justify-start lg:flex-col lg:justify-center lg:gap-5 lg:border-l lg:border-t-0 lg:pl-8 lg:pt-0">
          <div>
