...
const projects = [
  {
    ...
    description: "환자 건강 데이터 실시간 모니터링 대시보드",
    tags: ["React", "D3.js", "Node.js"],
  },
  {
    type: "Backend",
    title: "HealthAI API",
    description: "의료 영상 분석을 위한 딥러닝 API 서비스",
    tags: ["Python", "TensorFlow", "FastAPI"],
  },
  {
    type: "Mobile App",
    title: "PulseSync",
    description: "웨어러블 기기 데이터 동기화 플랫폼",
    tags: ["Flutter", "Firebase", "AWS"],
  },
  {
    type: "ML Model",
    title: "DiagnosisML",
    description: "증상 기반 질병 예측 머신러닝 모델",
    ...
    <div className="pt-24 pb-16">
      <div className="container mx-auto px-6">
          ...
          {projects.map((project, index) => (
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <span className="px-3 py-1.5 bg-secondary text-muted-foreground text-xs font-medium rounded-full">
                  {project.type}
                </span>
        ...
        <div className="bg-card border border-border rounded-2xl p-8 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <h2 className="text-xl font-semibold text-foreground mb-2">함께 일하고 싶으신가요?</h2>
            <p className="text-muted-foreground">새로운 헬스케어 프로젝트에 대해 이야기해요</p>
          </div>
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              className="w-12 h-12 bg-secondary border border-border rounded-full flex items-center justify-center hover:border-primary/50 transition-colors"
            >
